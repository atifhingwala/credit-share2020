...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    $sql4 = "INSERT into users (names,email,credit) VALUES ('$name','$email','$credits')";
    $result = $conn -> query($sql4);
    
    $_SESSION['added'] = "User added successfully";
      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-transaction my-5">
          <div class="card-body shadow-lg">
            <h5 class="card-title text-dark">Add User</h5>
            <form method="post">
              ...
              <div class="form-label-group">
                <label for="credits">Enter Initial Credits</label>  
                <input type="number" id="credits" name="credits" class="form-control" placeholder="" required>
              </div><br>

              <div class="form-group">
                <input class=" mt-1 btn btn-primary" type="submit" name="submit" value="Add">
